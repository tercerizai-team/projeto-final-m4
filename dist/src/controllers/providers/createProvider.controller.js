...
const createProvider_services_1 = require("../../services/providers/createProvider.services");
const createProviderController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const newProvider = yield (0, createProvider_services_1.createProviderService)(req.body);
