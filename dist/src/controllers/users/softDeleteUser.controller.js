...
const softDeleteUser_services_1 = require("../../services/users/softDeleteUser.services");
const softDeleteUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const deleteUser = yield (0, softDeleteUser_services_1.softDeleteUserService)(id);
