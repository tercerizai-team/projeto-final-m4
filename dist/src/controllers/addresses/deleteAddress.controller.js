...
const deleteAddress_service_1 = require("../../services/addresses/deleteAddress.service");
const deleteAddressController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const userId = req.userId;
    const addressDeleted = yield (0, deleteAddress_service_1.deleteAddressService)(id, userId);
