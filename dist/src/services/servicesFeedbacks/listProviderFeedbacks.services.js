...
const listProviderFeedbacksService = (providerId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!provider) {
        throw new AppError_1.default("Provider not found");
    }
    return provider.feedbacks;
});
exports.default = listProviderFeedbacksService;
