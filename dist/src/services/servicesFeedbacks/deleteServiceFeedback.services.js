...
const deleteServiceFeedbackService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield servicesFeedbacksRepository.delete({ id });
});
exports.default = deleteServiceFeedbackService;
