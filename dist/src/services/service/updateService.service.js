...
const updateServiceService = ({ isServiceFinished, isServiceCanceled, clientFinished, providerFinished, }, serviceId, userId, isAdm) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield serviceRepository.update({ id: serviceId }, newService);
    const updatedService = yield serviceRepository.findOneBy({ id: serviceId });
